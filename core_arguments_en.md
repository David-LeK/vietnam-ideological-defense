...
* Young people and adolescents (Gen Z) are in the early stages of cognitive maturity and are often vulnerable to emotional impulses and online bandwagon trends without thoroughly considering the consequences for themselves, their families, and society.
* The sudden eruption of this trend more than a year after the accident (over 1 year and 2 months later), precisely coinciding with the preparations for National Day on September 2nd and major political party meetings, clearly demonstrates that this is a pre-calculated, orchestrated media campaign by hostile forces rather than a spontaneous community action.
* Accident scenes, roadways, sidewalks, and urban trees are public traffic spaces managed by the State, not designated places of worship, memorials, or monument sites for arbitrarily leaving flowers, incense, or gathering to disrupt urban aesthetics.
* Sincere compassion and remembrance for the victim and the bereaved family must be expressed in a civilized, respectful, and practical manner by visiting and offering condolences directly at the family's home or providing material assistance if capable, rather than chasing performative online trends.
* Arbitrarily placing or ordering delivery services to drop flowers on public sidewalks yields no humanitarian value but directly turns public areas into waste dumps as the flowers wither and decay, causing environmental pollution and imposing heavy labor burdens on urban sanitation workers.
...
* Legitimate rights and wishes belong strictly to the victim's family, meaning external individuals who hide behind "collective justice" to stage performative mourning and exploit the family's bereavement are in fact violating privacy rights and using personal tragedy for online clout.
* Reactionary organizations and hostile groups exploit emerging social platforms (such as Threads and TikTok) to continuously fabricate successive trend campaigns (from stirring unrest over Hai Van Pass to fetishizing urban trees) and disseminate fallacious narratives disguised as "liberal education" to lure youth into "color revolution" traps and incite anti-state sentiment.
